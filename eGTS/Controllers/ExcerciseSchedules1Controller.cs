...
namespace eGTS.Controllers
{
    ...
    [ApiController]
    public class ExcerciseSchedules1Controller : ControllerBase
    {
        private readonly EGtsContext _context;

        public ExcerciseSchedules1Controller(EGtsContext context)
        {
            _context = context;
        }

        // GET: api/ExcerciseSchedules1
        [HttpGet]
        ...
        // DELETE: api/ExcerciseSchedules1/5
        [HttpDelete("{id}")]
